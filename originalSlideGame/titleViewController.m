...
NSLog(@"title%d",self.pathNo);
    ...
    self.playButton.titleLabel.font = [UIFont italicFlatFontOfSize:18]; // ボタンの文字ファンド
    ...
    self.createButton.titleLabel.font = [UIFont italicFlatFontOfSize:18]; // ボタンの文字ファンド
    ...
    self.appTitleLabel.font = [UIFont italicFlatFontOfSize:36];
    //-----------------------------------------------------------------
